...
function PANEL:Init()
	...
	self.BoarderWidth = 1
	self.BoarderCol = UPS_Config.Col.MN.DSWBoarderCol
	self.TextCol = UPS_Config.Col.MN.DSWTextCol
	self.Anim_Hover = 1
	self.Anim_Exit = 1
	self.Anim_Click = 1
	self.EventTime = nil
	self.HoverAnimTime = 0.3
	self.FXCol = UPS_Config.Col.MN.DSWClickFX
	self.AlignX = TEXT_ALIGN_CENTER
	self.AlignY = TEXT_ALIGN_CENTER
	self.BGCol = UPS_Config.BGCol.DSWButton
end
...
vgui.Register("UPS_DSWButton",PANEL,"DButton")