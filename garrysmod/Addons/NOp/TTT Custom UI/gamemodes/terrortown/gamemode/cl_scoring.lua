...
function CLSCORE:BuildHilitePanel(dpanel)
   ...
   bg.PaintOver = function()
                     ...
                     draw.RoundedBox(0, xwin - 15, ywin - 5, winlbl:GetWide() + 30, (winlbl:GetTall() + 10)/2, tttreskin.rrmwintitlegradient)
                  end
...
function CLSCORE:ShowPanel()
   ...
   dpanel.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.rrmbg )
    draw.RoundedBox( 0, 0, 0, w, 25, tttreskin.rrmbgtop )
 end
   ...
   dbut:SetTextColor( tttreskin.hsclosebtntext )
   dbut.OnCursorEntered = function(self)
    self:SetTextColor( tttreskin.hsclosebtntexthover )
  end
  dbut.OnCursorExited = function(self)
  ...
  dbut.Paint = function(self,w,h)
    ...
    draw.RoundedBox( 0, 1, 1, w-2, 1, tttreskin.rrmclosebtnshine )
   end
   ...
   dsave:SetTextColor( tttreskin.rrmsavetxtbtntext )
   dsave.OnCursorEntered = function(self)
    self:SetTextColor( tttreskin.rrmsavetxtbtntexthover )
  end
  dsave.OnCursorExited = function(self)
    self:SetTextColor( tttreskin.rrmsavetxtbtntext )
  end
  dsave.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.rrmsavetxtbtnborder )
    draw.RoundedBox( 0, 1, 1, w-2, h-1, tttreskin.rrmsavetxtbtngrdtop )

    surface.SetDrawColor( tttreskin.rrmsavetxtbtngrdbtm )
    surface.SetTexture( surface.GetTextureID( "gui/gradient" ) )
    surface.DrawTexturedRectRotated( w/2, h/2, h-1, w-2, 90 )

    draw.RoundedBox( 0, 1, 1, w-2, 1, tttreskin.rrmsavetxtbtnshine )
   end
   ...
   dtabsheet.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.rrmbody )
   end
      ...
      if (!v.Tab) then continue end
        ...
        v.Tab.Paint = function(self,w,h)
          if v.Tab == dtabsheet:GetActiveTab() then
            draw.RoundedBox(0, 0, 0, w, h, tttreskin.rrmbodytabselected)
          else
            draw.RoundedBox(0, 0, 0, w, h, tttreskin.rrmbodytab)
          end
      end
    end
   dpanel:MakePopup()
