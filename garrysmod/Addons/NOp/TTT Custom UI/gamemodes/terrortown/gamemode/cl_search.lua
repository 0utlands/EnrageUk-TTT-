...
local function ShowSearchScreen(search_raw)
   ...
   dframe.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.sbmbg )
    draw.RoundedBox( 0, 0, 0, w, 25, tttreskin.sbmbgtop )
   end
   ...
   ddesc.Paint = function(self, w, h)
      draw.RoundedBox( 0, 0, 0, w, h, tttreskin.sbmtextcontainer )
   end
   ...
   dident:SetTextColor( tttreskin.sbmconfirmbtntext )
   dident.OnCursorEntered = function(self)
    self:SetTextColor( tttreskin.sbmconfirmbtntexthover )
  end
  dident.OnCursorExited = function(self)
    self:SetTextColor( tttreskin.sbmconfirmbtntext )
  end
  dident.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.sbmconfirmbtnborder )
    draw.RoundedBox( 0, 1, 1, w-2, h-1, tttreskin.sbmconfirmbtngrdtop )

    surface.SetDrawColor( tttreskin.sbmconfirmbtngrdbtm )
    surface.SetTexture( surface.GetTextureID( "gui/gradient" ) )
    surface.DrawTexturedRectRotated( w/2, h/2, h-1, w-2, 90 )

    draw.RoundedBox( 0, 1, 1, w-2, 1, tttreskin.sbmconfirmbtnshine )
   end
   ...
   dcall:SetTextColor( tttreskin.sbmcalldetbtntext )
   dcall.OnCursorEntered = function(self)
    self:SetTextColor( tttreskin.sbmcalldetbtntexthover )
  end
  dcall.OnCursorExited = function(self)
    self:SetTextColor( tttreskin.sbmcalldetbtntext )
  end
  dcall.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.sbmcalldetbtnborder )
    draw.RoundedBox( 0, 1, 1, w-2, h-2, tttreskin.sbmcalldetbtngrdtop )

    surface.SetDrawColor( tttreskin.sbmcalldetbtngrdbtm )
    surface.SetTexture( surface.GetTextureID( "gui/gradient" ) )
    surface.DrawTexturedRectRotated( w/2, h/2, h-1, w-2, 90 )

    draw.RoundedBox( 0, 1, 1, w-2, 1, tttreskin.sbmcalldetbtnshine )
   end
   ...
   dconfirm:SetTextColor( tttreskin.sbmclosebtntext )
   dconfirm.OnCursorEntered = function(self)
    self:SetTextColor( tttreskin.sbmclosebtntexthover )
  end
  dconfirm.OnCursorExited = function(self)
    self:SetTextColor( tttreskin.sbmclosebtntext )
  end
  dconfirm.Paint = function(self,w,h)
    draw.RoundedBox( 0, 0, 0, w, h, tttreskin.sbmclosebtnborder )
    draw.RoundedBox( 0, 1, 1, w-2, h-2, tttreskin.sbmclosebtngrdtop )

    surface.SetDrawColor( tttreskin.sbmclosebtngrdbtm )
    surface.SetTexture( surface.GetTextureID( "gui/gradient" ) )
    surface.DrawTexturedRectRotated( w/2, h/2, h-1, w-2, 90 )

    draw.RoundedBox( 0, 1, 1, w-2, 1, tttreskin.sbmclosebtnshine )
   end
