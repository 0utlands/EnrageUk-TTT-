// By MaZy 
// this is taken from example. I changed few things
...
if CLIENT then
   ...
   SWEP.Instructions		= "Freezes Player ;)"
   SWEP.Slot				= 9
   SWEP.SlotPos				= 0
...
function SWEP:CreateGrenade(src, ang, vel, angimp, ply)
   local gren = ents.Create("ttt_freezegrenade_proj")
